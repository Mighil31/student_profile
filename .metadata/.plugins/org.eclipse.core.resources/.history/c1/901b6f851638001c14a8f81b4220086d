...
<body id="root">
    ...
    <header>
        ...
        <a href="./About.html">Student Profile</a>
    </header>
    <div class="LeftPanel">
        <div class="Introtext">
            <h1>Build and discover profiles</h1>
            <p>
                Hop into our application to discover talented students all over the world.
        ...
        <form action="login" method="get" class="LoginForm">
            ...
            <div class="input-field">
                <input type="password" name="password" id="pwd" value="<c:out value='${student.password}' />" required />
    ...
    <img src="../media/illustrations/login_image.png" height="50px" width="100px"></img>
    </div>
